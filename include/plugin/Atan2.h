...
class Atan2 final : public nvinfer1::IPluginV2DynamicExt
{
public:
    /**
    ...
    */
    Atan2();
    Atan2(void const* serialData, size_t serialLength);

    ~Atan2() override = default;
...
class Atan2PluginCreator : public IPluginCreator
{
public:
    // 创建一个空的mPluginAttributes初始化mFC
    Atan2PluginCreator();
    ~Atan2PluginCreator() override = default;
